...
export default function GlowGuide() {
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden bg-gradient-to-br from-white via-gray-50 to-gray-100">
      {/* Glow decorativo */}
      <div className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-gray-200 rounded-full blur-3xl opacity-30"></div>
      <div className="absolute bottom-[-120px] right-[-120px] w-[400px] h-[400px] bg-gray-300 rounded-full blur-3xl opacity-30"></div>

      <div className="relative text-center max-w-2xl animate-fadeUp">
        <h1 className="text-4xl md:text-5xl font-semibold mb-6">Glow Guide</h1>
        ...
        <p className="text-sm text-gray-500 mb-10">
          Muy pronto estará disponible este proyecto con contenido exclusivo,
          guías de cuidado y recomendaciones personalizadas.
        </p>

        <div className="inline-block border border-black px-6 py-3 rounded-full text-sm font-medium bg-white/60 backdrop-blur-md">
          Próximamente
        </div>
      </div>
    </div>
