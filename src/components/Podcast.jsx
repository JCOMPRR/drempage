...
export default function PodcastSection() {
  ...
  }, [i18n.language]); // 👈 importante cuando cambias idioma
    ...
    <section className="bg-white py-20">
      ...
      >
        ...
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
          {t("podcast.descripcion")}
        </p>

        <div className="mt-12 aspect-video w-full overflow-hidden rounded-sm shadow-md">
          <iframe
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 mt-10 px-10 py-3
                     ...
                     hover:bg-[#17a74a] transition-all duration-300
