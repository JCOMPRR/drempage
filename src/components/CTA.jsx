...
export default function CTAWhatsapp() {
  ...
  }, [i18n.language]); // 👈 importante para reanimar al cambiar idioma

  // 👇 Mensaje dinámico para WhatsApp
  const whatsappMessage = encodeURIComponent(t("ctaWhatsapp.mensaje"));
  const whatsappLink = `https://wa.me/5216621881994?text=${whatsappMessage}`;
    ...
    <section className="bg-gray-50 py-20">
      <div
        ...
        className={`
          ...
          ${visible ? "animate-fadeUp" : "opacity-0 translate-y-6"}
        `}
      >
        <h2 className="font-heading text-3xl md:text-4xl text-black">
          {t("ctaWhatsapp.titulo")}
        </h2>

        <p className="mt-4 text-gray-600">{t("ctaWhatsapp.descripcion")}</p>
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 mt-8 px-8 py-3
                     ...
                     hover:bg-[#B8932F] transition-all duration-300
